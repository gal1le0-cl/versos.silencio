              ...
              <div className="flex-1 flex flex-col overflow-auto">
                <header className="px-4 py-5 flex-shrink-0">
                  <h1 className="font-basset text-4xl lg:text-[80px] leading-none">
                    FRAGMENTOS <br /> DEL OLVIDO
                  </h1>
                </header>

                {/* Contenido principal */}
                <div className="p-4 lg:p-6">
                  <h2 className="font-bold text-lg lg:text-xl mb-4">Collage Fotográfico</h2>
                  <p className="text-sm text-[#696969] leading-relaxed mb-6">
                    Explora esta recopilación de fotografías en blanco y negro realizadas
                    desde la ruta al exilio republicano español. Cada imagen captura un
                    fragmento de memoria que, en conjunto, construyen un relato visual
